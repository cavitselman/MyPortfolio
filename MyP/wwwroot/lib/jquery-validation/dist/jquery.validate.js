...
$.extend( $.validator, {
	...
	messages: {
		...
		max: $.validator.format( "Lütfen {0}'dan küçük veya ona eşit bir değer girin." ),
		min: $.validator.format( "Lütfen {0}'dan büyük veya ona eşit bir değer girin." ),
		step: $.validator.format( "Lütfen {0}'ın katlarını girin." )
	},
